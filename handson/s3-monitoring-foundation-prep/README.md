...
このディレクトリは、Section 3で使う教材環境の作成、サンプル投入、初期確認、削除確認の手順です。
...
| [`cleanup_commands.md`](cleanup_commands.md) | CloudFormation delete-stackと削除後確認コマンド |
...
6. 教材環境を作成する
7. サンプルログとメトリクスを投入する
8. [`logs_insights_queries.md`](logs_insights_queries.md) のクエリでログを確認する
9. [`validation_checklist.md`](validation_checklist.md) でDashboard、Alarm、SNS、Log Groupの初期状態を確認する
10. 後続章へ進む前に、[`cleanup_commands.md`](cleanup_commands.md) と削除予定時刻を確認する
...
- AWSリソースを作成した場合は、同じ学習セッション内で [`cleanup_commands.md`](cleanup_commands.md) を実行します。
